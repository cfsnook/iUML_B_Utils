...
To aid clarity in this document, the following conventions are used. Eclipse and Rodin tool commands are shown in small caps. E.g. \command{General - Existing Projects into Workspace}.
